...
<caption>Profile</caption>
    <thead>
        <tr><th>First Name:</th><td>
            <?php echo $_SESSION['firstName']; ?> </td>
        <tr><th>Last Name:</th><td>
            <?php echo $_SESSION['lastName']; ?> </td>
        <tr><th>D.O.B</th><td>
            <?php echo $_SESSION['dateOfBirth']; ?> </td>
        <tr><th>Gender</th><td>
            <?php echo $_SESSION['gender']; ?> </td>
        <tr><th>Mobile</th><td>
            <?php echo $_SESSION['mobile']; ?> </td>
        <tr><th>Home Address</th><td>
            <?php echo $_SESSION['homeAddress']; ?> </td>
        <tr><th>Email:</th><td>
            <?php echo $_SESSION['email']; ?> </td>
    </thead>
                        <tr>
                        <td>
                        <div id="editP"><a href="editProfile.php"><br> EDIT </a></div>
                        <div id="logoutP"><a href="process/logout.php"><br> LOGOUT </a></div>
                        </td>
                    </tr>
</table>
				</div>
